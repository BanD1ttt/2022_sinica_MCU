...
static const uint16_t restartGyro = 0x8002;
static const uint16_t detectResult = 0x8003;
}
...
static const uint16_t restartGyro = 0;
static const uint16_t detectResult = 0;
}
